const lang = {
    ...
    metaTitle: {
        "ua": "Перетяжка керма, ручок КПП, пильників, підлокітників в Україні. Швидко та якісно.",
        "ru": "Перетяжка рулей, ручек КПП, пыльников, подлокотников в Украине. Быстро и качественно.",
    },
    metaDscription: {
        "ua": "Автомобілістам. Перетяжка потертого керма та дрібних деталей автомобілів в шкіру або замінник (ручки КПП, пильники, підлокітники, дверні картки та інше). Дивиться фото перетяжки кермів та інших деталей автомобілів на сайті. Приймаємо закази по Україні.",
        "ru": "Автомобилистам. Перетяжка потёртого руля и мелких деталей автомобилей в кожу или заменитель (ручки КПП, пыльники, подлокотники, дверные карты и др.). Смотрите фото перетяжки рулей и других деталей автомобелей на сайте. Принимаем закази по Украине.",
    },
    title : {
